...
@author: shylent
'''
from tftp.datagram import (split_opcode, BinaryProtocolError, TFTPDatagramFactory,
...
class OpcodeProcessing(unittest.TestCase):
    ...
    def test_zero_length(self):
        self.assertRaises(BinaryProtocolError, split_opcode, '')

    def test_truncated_opcode(self):
        self.assertRaises(BinaryProtocolError, split_opcode, '0')
    ...
    def test_unknown_opcode(self):
        opcode = 17
        self.assertRaises(BinaryProtocolError, TFTPDatagramFactory, opcode, 'foobar')
...
class ConcreteDatagrams(unittest.TestCase):
    ...
    def test_rq(self):
        ...
        self.assertRaises(BinaryProtocolError, RQDatagram.from_wire, 'foobar')
    ...
    def test_data(self):
        # Zero-length payload
        self.assertRaises(BinaryProtocolError, DATADatagram.from_wire, '')
        # One byte payload
        self.assertRaises(BinaryProtocolError, DATADatagram.from_wire, '\x00')
        # Zero-length data
    ...
    def test_ack(self):
        # Zero-length payload
        self.assertRaises(BinaryProtocolError, ACKDatagram.from_wire, '')
        # One byte payload
        self.assertRaises(BinaryProtocolError, ACKDatagram.from_wire, '\x00')
        # Full-length payload
        ...
        self.assertRaises(BinaryProtocolError, ACKDatagram.from_wire, '\x00\x10foobarz')

    def test_error(self):
        # Zero-length payload
        self.assertRaises(BinaryProtocolError, ERRORDatagram.from_wire, '')
        # One byte payload
        self.assertRaises(BinaryProtocolError, ERRORDatagram.from_wire, '\x00')
        ...
        self.assertEqual(dgram.errmsg, 'foobar')
        # Unknown errorcode
        self.assertRaises(BinaryProtocolError, ERRORDatagram.from_wire, '\x00\x0efoobar')
        # Unknown errorcode in from_code
        self.assertRaises(BinaryProtocolError, ERRORDatagram.from_code, 13)
